...
export default function Contact() {
  return (
    <Section id="contact" className="relative overflow-hidden pt-10 py-16 lg:py-24 bg-white dark:bg-background">
      <Container>
            ...
            <div className="flex flex-col items-start max-w-xl">
              ...
              <div className="mt-12 flex flex-col gap-8">
                <div>
                  ...
                  <a href="mailto:hello@jinanam.in" className="mt-2 text-xl font-medium text-[#1A73E8] transition-colors hover:text-blue-700">
                    hello@jinanam.in
                  </a>
                </div>
